  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'inner-soft': 'inset 0 2px 4px 0 rgba(0, 0, 0, 0.08), inset 0 0 0 1px rgba(255, 255, 255, 0.05)',
        ...
        'layered': '0 1px 2px rgba(0,0,0,0.1), 0 4px 8px rgba(0,0,0,0.1), 0 8px 16px rgba(0,0,0,0.1)',
        'depth': '0 1px 3px rgba(0,0,0,0.12), 0 1px 2px rgba(0,0,0,0.24)',
        'depth-hover': '0 14px 28px rgba(0,0,0,0.25), 0 10px 10px rgba(0,0,0,0.22)'
      },
      backgroundImage: {
        ...
        'gradient-spotlight': 'radial-gradient(circle at var(--mouse-x, center) var(--mouse-y, center), rgba(255,255,255,0.1) 0%, transparent 50%)',
