...
function QuickAction({
  ...
  const colorStyles = {
    ...
    orange: {
      ...
      hover:
        "hover:from-orange-100 hover:to-orange-150 dark:hover:from-orange-900/30 dark:hover:to-orange-800/30",
  ...
  return (
    <Link href={linkHref} className="group block">
      <Card
        className={`${colorStyles.gradient} ${colorStyles.border} ${colorStyles.hover} ${colorStyles.ring} border transition-all duration-300 hover:shadow-xl hover:-translate-y-1 overflow-hidden`}
      >
