    ...
    return (
        <div className="flex items-center gap-3">
            <DropdownMenu>
                ...
                <DropdownMenuContent
                    align="end"
                    className="w-56 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 shadow-lg"
                >
                    ...
                    >
                        <div className="flex items-center">
                            ...
                            <span className="text-gray-700 dark:text-gray-300">{t('activateAll')}</span>
                        </div>
                    </DropdownMenuItem>
                    ...
                    >
                        <div className="flex items-center">
                            ...
                            <span className="text-gray-700 dark:text-gray-300">{t('deactivateAll')}</span>
                        </div>
                    </DropdownMenuItem>
                    ...
                    >
                        <div className="flex items-center">
                            ...
                            <span className="text-gray-700 dark:text-gray-300">{t('exportCsv')}</span>
                        </div>
                    </DropdownMenuItem>
                    ...
                    >
                        <div className="flex items-center">
                            ...
                            <span className="text-red-600 dark:text-red-400 font-medium">{t('deleteSelected')}</span>
                        </div>
                    </DropdownMenuItem>
                </DropdownMenuContent>
            </DropdownMenu>
