    ...
    try {
      switch (action) {
        ...
        case "activate": {
          ...
          toast.success(
            t("messages.bulkActivateSuccess", { count: selectedUsers.length })
          );
          break;
        }
        case "deactivate": {
          ...
          toast.success(
            t("messages.bulkDeactivateSuccess", { count: selectedUsers.length })
          );
          break;
        }
        case "export": {
    ...
    const csvContent = [
      ...
      ...selectedUserData.map((user) =>
        [
          ...
          user.currentRole
            ? user.currentRole.displayName.replace(/,/g, "")
            : t("noRoleAssigned"),
              ...
              <div className="flex items-center gap-6 flex-wrap">
                <div className="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400">
                  ...
                  <span className="font-medium">
                    {users.filter((u) => u.currentRole).length}{" "}
                    {t("rolesAssigned")}
                  </span>
                </div>
                <div className="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400">
                    ...
                    <TableCell>
                      {user.currentRole ? (
                        <Badge
                          ...
                          style={{
                            backgroundColor:
                              user.currentRole.color || undefined,
                          }}
                          className={
                            !user.currentRole.color
                              ? "bg-blue-100 text-blue-800 dark:bg-blue-900/20 dark:text-blue-300 px-3 py-1.5 text-sm font-medium"
                              : "text-white px-3 py-1.5 text-sm font-medium shadow-sm"
                          }
                        >
                        ...
                        <Badge
                          variant="outline"
                          className="border-gray-300 dark:border-gray-600 text-gray-600 dark:text-gray-400 px-3 py-1.5 text-sm"
                        >
                    ...
                    <TableCell className="text-right pr-6">
                      <DropdownMenu>
                        ...
                        >
                          ...
                          <DropdownMenuItem
                            onClick={() =>
                              handleQuickAction("edit-user", user.id)
                            }
                          ...
                          <DropdownMenuItem
                            onClick={() =>
                              handleQuickAction("assign-role", user.id)
                            }
                            className="hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors duration-150 cursor-pointer"
                          >
                            <div className="flex items-center">
