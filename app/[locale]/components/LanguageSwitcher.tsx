...
export default function LanguageSwitcher({ isAdmin: _isAdmin = false }: LanguageSwitcherProps) {
    ...
    return (
        <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-48 border-border/60 shadow-xl backdrop-blur-sm">
