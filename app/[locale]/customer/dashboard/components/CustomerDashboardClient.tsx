...
function QuickAction({
  ...
  const colorStyles = {
    ...
    pink: {
      ...
      hover:
        "hover:from-pink-100 hover:to-pink-150 dark:hover:from-pink-900/30 dark:hover:to-pink-800/30",
    ...
    indigo: {
      ...
      hover:
        "hover:from-indigo-100 hover:to-indigo-150 dark:hover:from-indigo-900/30 dark:hover:to-indigo-800/30",
    ...
    emerald: {
      ...
      hover:
        "hover:from-emerald-100 hover:to-emerald-150 dark:hover:from-emerald-900/30 dark:hover:to-emerald-800/30",
  ...
  return (
    <Link href={linkHref} className="group block">
      <Card
        className={`${colorStyles.gradient} ${colorStyles.border} ${colorStyles.hover} ${colorStyles.ring} border transition-all duration-300 hover:shadow-xl hover:-translate-y-1 overflow-hidden customer-widget`}
      >
        <CardContent className="p-6">
          <div className="flex items-start justify-between">
            <div className="flex items-start space-x-4">
              <div
                className={`p-4 rounded-xl ${colorStyles.icon} shadow-lg group-hover:scale-110 transition-all duration-300`}
              >
    ...
    <Card className="border-0 shadow-xl bg-gradient-to-br from-white to-gray-50 dark:from-slate-800 dark:to-slate-900">
      <CardContent className="p-6">
        <div className="flex items-center justify-between mb-6">
          ...
          <Link
            href="/customer/orders"
            className="text-purple-600 hover:text-purple-700 dark:text-purple-400 dark:hover:text-purple-300 font-medium flex items-center gap-1"
          >
            {t("viewAll")}
        ...
        <div className="space-y-4">
          {orders.map((order) => (
            <div
              key={order.id}
              className="flex items-center justify-between p-4 rounded-lg bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 hover:shadow-md transition-all duration-200"
            >
