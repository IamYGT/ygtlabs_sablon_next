...
import { FaArrowRight, FaMapMarkerAlt, FaShieldAlt, FaClock } from 'react-icons/fa';
import { motion } from 'framer-motion';

function Hero() {
  const features = [
    { icon: <FaShieldAlt />, title: 'Premium Hizmet', subtitle: 'Uzman Ekip' },
    { icon: <FaClock />, title: 'Hızlı Teslimat', subtitle: 'Aynı Gün' }
  ];
