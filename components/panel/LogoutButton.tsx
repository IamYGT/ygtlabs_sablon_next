...
interface LogoutButtonProps {
    className?: string;
    variant?: "outline" | "ghost" | "default" | "destructive" | "secondary" | "link" | null | undefined;
...
export default function LogoutButton({
    ...
    const isMouseOverSidebar = useCallback(() => {
        ...
        return lastMousePosition.current.x >= rect.left &&
    ...
    return (
        <div ref={containerRef}>
            <DropdownMenu open={dropdownOpen} onOpenChange={handleDropdownOpenChange}>
                ...
                <DropdownMenuContent align="end" className="w-56 shadow-lg border border-slate-200 dark:border-slate-700 z-[10000]">
                    <DropdownMenuItem
