    ...
    useEffect(() => {
        const interval = setInterval(() => {
            setSystemStatus(prev => ({
                ...
                activeUsers: Math.max(10, Math.min(50, prev.activeUsers + Math.floor((Math.random() - 0.5) * 6)))
            }));
        }, 5000);
    ...
    return (
        <DropdownMenu open={isExpanded} onOpenChange={setIsExpanded}>
            <DropdownMenuTrigger asChild>
                ...
                >
                    <div className={`${getHealthColor(systemStatus.systemHealth)} transition-colors duration-300`}>
            ...
            <DropdownMenuContent align="end" className="w-80 sm:w-96 border-border/60 shadow-xl p-0">
